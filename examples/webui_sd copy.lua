onOutput = async(function(triggerId)
    ...
    local basetag = "score_9, score_8_up, score_7_up, realistic, real, (natural huge breasts:1.1), 1girl, korean idol, <lora:Expressive_H:1.2>, <lora:natural_breasts_v1:1.4>,"
